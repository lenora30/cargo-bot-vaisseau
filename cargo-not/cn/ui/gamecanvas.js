 ...
 * @extends {goog.graphics.CanvasGraphics}
 */
cn.ui.GoalCanvas = function(width, height, opt_domHelper) {
  goog.base(this, width, height, null, null, opt_domHelper);
};
goog.inherits(cn.ui.GoalCanvas, goog.graphics.CanvasGraphics);
 ...
 * @param {!cn.model.PathModel} model The model to draw.
 */
 cn.ui.GoalCanvas.prototype.drawPathModel = function(model) {
  this.drawPath(model.path, model.stroke, model.fill);
  model.forEachSubModel(function(model) { this.drawPathModel(model); }, this);
};
 ...
 * @inheritDoc
 */
 cn.ui.GoalCanvas.prototype.enterDocument = function() {
  goog.base(this, 'enterDocument');
  goog.dom.classlist.set(this.getElement(), cn.constants.GOAL_CLASS_NAME);
};